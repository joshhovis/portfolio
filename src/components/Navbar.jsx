        ...
        <div className="sticky top-0 z-50 flex items-center justify-center w-full px-5 h-15 bg-gray-100 dark:bg-black dark:text-gray-100">
            <nav className="flex items-center justify-between w-full h-20 max-w-[95rem]">
                ...
                <ul className='flex items-center h-full space-x-1'>
                    <li>
                        <a class="group grid place-items-center w-10 h-10 relative overflow-hidden rounded-md" aria-label="Linkedin profile" href="https://www.linkedin.com/in/joshua-hovis/">
                            <div class="absolute inset-0 transition-opacity duration-500 opacity-0 group-hover:opacity-100 bg-gradient-to-tr hover:from-[#212325] hover:to-[#212325] z-0">
                            </div>
