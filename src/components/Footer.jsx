...
const Footer = () => {
    return (
        <div className='absolute bottom-0 w-full px-16 py-6 pt-12 mt-5 sm:pt-6 bg-gray-100 dark:bg-black dark:text-gray-100 transition-colors duration-300'>
                ...
                <div className='grid gap-y-12 items-center justify-items-center sm:grid-cols-3 sm:justify-items-stretch w-full'>
                    <div className='flex flex-col gap-4 items-center'>
                        ...
                        <div className='grid grid-cols-2 w-full sm:w-min sm:flex gap-4 text-xl'>
                            <ScrollLink to='/' smooth={true} duration={600} offset={-100} className='hover:text-gray-700 dark:hover:text-gray-300 transition-colors'>About</ScrollLink>
                            <ScrollLink to='/' smooth={true} duration={600} offset={-100} className='hover:text-gray-700 dark:hover:text-gray-300 transition-colors'>Skills</ScrollLink>
                            <ScrollLink to='/' smooth={true} duration={600} offset={-100} className='hover:text-gray-700 dark:hover:text-gray-300 transition-colors'>Projects</ScrollLink>
                            <ScrollLink to='/' smooth={true} duration={600} offset={-100} className='hover:text-gray-700 dark:hover:text-gray-300 transition-colors'>Experience</ScrollLink>
                        </div>
                    </div>
